...
Route::group(['namespace'=>'Admin','middleware' => ['auth','lock','check_refer'],'prefix'=>'admin'], function() {
    ...
    //Second banner route
    Route::get('sbanner', [BannerController::class,'sbanner'])->name('sbanner');
    Route::get('sbannercreate', [BannerController::class,'sbannercreate'])->name('sbannercreate');
    Route::post('sbannerstore', [BannerController::class,'sbannerstore'])->name('sbannerstore');
    Route::get('sbanneredit/{id}', [BannerController::class,'sbanneredit'])->name('sbanneredit');
    Route::post('sbannerupdate/{id}', [BannerController::class,'sbannerupdate'])->name('sbannerupdate');
    Route::get('sbannerdelete/{id}', [BannerController::class,'sbannerdelete'])->name('sbannerdelete');

                ...
                <div class="row">
                  <div class="col-sm-12">
                      <div class="why_choose_inn">
                          <div class="d-flex w-100 justify-content-center align-items-center bg-success text-white py-3">
                              <h1>Product Description's</h1>
                          </div>
                          <!--<div class="why_choose" style="text-align:left; height:75vh">-->
                          <!--    <div class="why_choose_midd d-flex w-100 justify-content-left align-items-start">-->
                          <!--        <h2 class="why_choose_widget text-align-left">-->
                          <!--          {{$campaign_data->description}}-->
                          <!--        </h2>-->
                                  
                          <!--        <div class="why_choose_widget">-->
                          <!--            <div class="why_img review_slider owl-carousel">-->
                          ...
                          <div class="row">
                              ...
                              <div class="col-md-6">
                                    <div class="review_slider owl-carousel">
                                          @foreach($campaign_data->images as $key=>$value)
                                            <div class="review_item">
                                                <img src="{{asset($value->image)}}" alt="" height="500" class="w-md-50 w-lg-75">
                                            </div>
                                            @endforeach
                                    </div>
                              </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="rev_inn">
                            <div class="col-sm-12">
                                 <div class="cont_num text-center">
                                <h2>আমাদের থেকে বিস্তারিত জানতে এই নাম্বারে কল করুন {{$contact->phone}}</h2>
        ...
        <div class="container">
         ...
         <section class="camp_video_sec">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <div class="why_choose_head pb-4">
                             <h2>আমাদের উপর কেন আস্থা রাখবেন ??</h2>
                        </div>
                         <div class="border_line"></div>
                        <div class="camp_vid">
                            <iframe width="853" height="480" src="https://www.youtube.com/embed/Fy9S0CQYY5w?si=WadlnLTZ41kUkssL" title="E-commerce website review. Make your website with in 15 min." frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen=""></iframe>
                        </div>
                    </div>
                </div>
            </div>

                ...
                <form action="{{route('campaign.store')}}" method="POST" class=row data-parsley-validate=""  enctype="multipart/form-data">
                    ...
                    <div class="col-sm-6 mb-3 d-none">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('banner') is-invalid @enderror " name="banner"    id="banner" value="null">
                            @error('banner')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="col-sm-12 mb-3 d-none">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('image_one') is-invalid @enderror " name="image_one"  value="null"  id="image_one">
                            @error('image_one')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="col-sm-6 d-none">
                        <div class="form-group mb-3">
                            <label for="review" class="form-label">Purpose of Images *</label>
                            <input type="text" class="form-control @error('review') is-invalid @enderror" name="review" value="null"  id="review">
                            @error('review')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="col-sm-12 my-3 d-none">
                        <div class="form-group">
                            ...
                            <textarea name="short_description"  rows="6" class="form-control @error('short_description') is-invalid @enderror" >null</textarea>
                    ...
                    <div class="col-sm-12 my-3">
                        <div class="form-group">
                            ...
                            <textarea name="description"  rows="6" class="form-control @error('description') is-invalid @enderror" ></textarea>
                            @error('description')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>

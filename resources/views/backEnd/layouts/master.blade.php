    ...
    <div id="wrapper">
        ...
        <div class="container-fluid">
          ...
          <div class="logo-box">
            ...
            <a href="{{url('admin/dashboard')}}" class="logo logo-light text-center">
              ...
              <span class="logo-lg">
                <img src="{{asset($generalsetting->white_logo)}}" alt="" height="50" width="220" />
              </span>
            </a>
          </div>
              ...
              <li class="">
                ...
                <div class="collapse" id="sidebar-landing-page">
                  <ul class="nav-second-level">
                    ...
                    <li>
                      <a href="{{route('campaign.index')}}"><i data-feather="file-plus"></i>All Campaign</a>
                    </li>
                  </ul>
                </div>
              </li>
              ...
              <li>
                ...
                <div class="collapse" id="siebar-banner">
                  <ul class="nav-second-level">
                    ...
                    {{-- <li>
                      <a href="{{route('sbanner')}}"><i data-feather="file-plus"></i>Second Banner</a>
                    </li> --}}
                  </ul>
                </div>
              </li>
      ...
      <div class="content-page">
        ...
        <footer class="footer">
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-12 text-end">&copy; {{$generalsetting->name}} <a href="https://wa.me/8801751155302" target="_blank">SuvroIt.online</a></div>
            </div>
          </div>
        </footer>
        <!-- end Footer -->

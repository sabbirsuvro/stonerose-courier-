...
class FrontendController extends Controller
{
    ...
    {
        // return "Welcome to suvroit.online";
        ...
        // return $homeproducts;
        return view('frontEnd.layouts.pages.index', compact('sliders', 'frontcategory', 'hotdeal_top', 'hotdeal_bottom', 'homeproducts', 'sliderbottomads', 'footertopads','sbanner'));
    }
